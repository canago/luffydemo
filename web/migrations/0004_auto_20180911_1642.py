# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2018-09-11 08:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homework', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.Homework')),
                ('mentor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='my_stu_homework_record', to=settings.AUTH_USER_MODEL, verbose_name='导师')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.EnrolledDegreeCourse', verbose_name='学生')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrolled_degree_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.EnrolledDegreeCourse', verbose_name='学生')),
                ('mentor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mentor', to=settings.AUTH_USER_MODEL, verbose_name='导师')),
            ],
            options={
